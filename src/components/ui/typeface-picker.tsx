...
/*
  TypefacePicker — exploration tool (Hard Rule #12: lives only while the
  type decision is open). Sets --font-sans on :root; everything inherits.
  Geist is the locked default; the alternates ride on exploration-only
  @imports in index.css that go when the decision is final.
*/

const FACES = [
  { id: 'geist',   label: 'Geist',     stack: "'Geist', system-ui, sans-serif",         vibe: 'Sharp, technical — the locked default' },
